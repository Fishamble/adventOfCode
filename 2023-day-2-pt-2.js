  ...
  games.forEach((game) => {
    ...
    game.forEach((sets) => {
      sets.split(",").forEach((hand) => {
        ...
        if (handColor === "red" && handAmount > redHighest) redHighest = +handAmount;
        else if (handColor === "green" && handAmount > greenHighest) greenHighest = +handAmount;
        else if (handColor === "blue" && handAmount > blueHighest) blueHighest = +handAmount;
      });
    });
    output += redHighest * greenHighest * blueHighest;
  });
